...
class MainViewModel : ViewModel() {
    ...
    private val _llmBaseUrl = mutableStateOf("")
    val llmBaseUrl: State<String> = _llmBaseUrl

    private val _llmModelName = mutableStateOf("")
    val llmModelName: State<String> = _llmModelName
    ...
    fun initialize(context: Context) {
        ...
        _openAiKey.value = SharedPrefsUtils.getApiKey(context)
        _llmBaseUrl.value = SharedPrefsUtils.getBaseUrl(context)
        _llmModelName.value = SharedPrefsUtils.getModelName(context)
    ...
    fun updateLlmModelName(model: String) {
        _llmModelName.value = model
    }

    fun saveSettings(context: Context) {
        SharedPrefsUtils.setApiKey(context, _openAiKey.value)
        SharedPrefsUtils.setBaseUrl(context, _llmBaseUrl.value)
        SharedPrefsUtils.setModelName(context, _llmModelName.value)
