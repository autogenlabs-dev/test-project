                ...
                if (viewModel.showOnboarding.value) {
                    ...
                    when (viewModel.selectedScreen.value) {
                        ...
                        "settings" -> SettingsScreen(
                            ...
                            llmBaseUrl = viewModel.llmBaseUrl.value,
                            onLlmBaseUrlChange = viewModel::updateLlmBaseUrl,
                            llmModelName = viewModel.llmModelName.value,
                            onLlmModelNameChange = viewModel::updateLlmModelName,
